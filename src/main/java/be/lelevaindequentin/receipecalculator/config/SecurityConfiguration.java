package be.lelevaindequentin.receipecalculator.config;

import static org.springframework.security.config.Customizer.withDefaults;
import static org.springframework.security.oauth2.core.oidc.StandardClaimNames.PREFERRED_USERNAME;
import static org.springframework.security.web.util.matcher.AntPathRequestMatcher.antMatcher;

import be.lelevaindequentin.receipecalculator.security.*;
import be.lelevaindequentin.receipecalculator.security.SecurityUtils;
import be.lelevaindequentin.receipecalculator.security.oauth2.AudienceValidator;
import be.lelevaindequentin.receipecalculator.security.oauth2.CustomClaimConverter;
import be.lelevaindequentin.receipecalculator.web.filter.SpaWebFilter;
